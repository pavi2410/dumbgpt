import pytest
import numpy as np
from dumbgpt.model.attention import ScaledDotProductAttention, MultiHeadAttention, PositionalEncoding
...
class TestScaledDotProductAttention:
    ...
    def test_attention_scores_computation(self):
        ...
        assert np.allclose(output[0], V[0], atol=1.0)  # First token attends mainly to itself
        assert np.allclose(output[1], V[1], atol=1.0)  # Second token attends mainly to itself
